...
public class Step8ForSubmitterReceiptViewerService {
    ...
    public ResponseDTO<DriveReportSearchOptionDTO> findRecommendKeywordList() {
        ...
        option.setCarNos(step8Mapper.selectCarNoSearchOption(getUserIdFk()));
        option.setFromSites(step8Mapper.selectFromSiteSearchOption(getUserIdFk()));
        option.setToSites(step8Mapper.selectToSiteSearchOption(getUserIdFk()));
        option.setItems(step8Mapper.selectItemSearchOption(getUserIdFk()));
