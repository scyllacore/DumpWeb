class Step11GroupHandler {
    ...
    activeInputElementNames = ['groupDriverRetrievalBtn', 'groupReportRetrievalBtn', 'groupTitle', 'groupMemo', 'imageUploadBtn', 'newDriveReport']
    ...
    async loadInputDataByUrlParams() {
        ...
        const inputData = await this.requestHandler
            .post('/manage/step11' + '/fetch' + '/groupDriveReportDetails', reqData);
    ...
    async save() {
        ...
        const responseData = await this.requestHandler.postFormData('/manage/step11' + '/fetch' + '/groupDriveReportSave'
            , requestForm);
    ...
    async remove() {
        ...
        const responseData = await this.requestHandler.delete('/manage/step11' + '/fetch' + '/groupDriveReportRemove'
    ...
    async groupReportsRetrieval() {
        ...
        const responseData = await this.requestHandler.post('/manage/step11' + '/fetch' + '/groupDriveReportList'
            , this.jsonHandler.convertObjectToJson(requestObj));
