...
$(document).ready(function() {
    ...
    var id = getCookie("dispatchManageId");
    var pw = localStorage.getItem("dispatchManagePw");
    var ss = getCookie("dispatchManageSS");
    ...
    if(id.length > 0 ){
        ...
        $('.ssList li').each(function () {
            if($(this).attr("select-data") == ss){
                var _li_value = $(this).html();
                $(".b-selectCustomWrap > a").html(_li_value);
                $(".b-selectCustom").removeClass("active");
                $(".select_icon").toggleClass("active");
        ...
        success : function(data) {
            ...
            if(json.httpCode == 200){
                if($("[name=id_save]:checked").val() != undefined){
                    setCookie("dispatchManageId",  $("[name=userId]").val(), 365);
                    localStorage.setItem("dispatchManagePw",  $("[name=userPw]").val(), 365);
